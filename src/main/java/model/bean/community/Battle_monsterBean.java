...
public class Battle_monsterBean {
	...
	public Battle_monsterBean() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Battle_monsterBean(int monster_id, String monster_name, String monster_img, int lv, int exp, int job_exp,
